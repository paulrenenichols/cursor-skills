...
**Document locations:** Keep all docs under `_docs/`. The project overview is `_docs/planning/milestones/00-initial-milestones/README.md`. All definition docs (user flow, auth, tech stack, UI, theme, project rules) go in the **same folder**: `_docs/planning/milestones/00-initial-milestones/`. Put milestones in `_docs/milestones/`. Put setup guides in `_docs/planning/setup/`. This is a flat layout: no `project-overview/` or `definition/` subfolders.

1. `_docs/planning/milestones/00-initial-milestones/README.md`

   - Establish overall project purpose, scope, and goals (overview). Link to the other planning files in this folder.

2. `_docs/planning/milestones/00-initial-milestones/user-flow.md`

   - Clarify how users will interact with the application (landing, registration, navigation, redirects, etc).

3. `_docs/planning/milestones/00-initial-milestones/auth.md`

   - Describe how authentication works in the app.

4. `_docs/planning/milestones/00-initial-milestones/tech-stack.md`

   - Describe the core technologies used (Node, Next.js, TypeScript, etc.) and their roles.

5. `_docs/planning/milestones/00-initial-milestones/ui-rules.md`

   - Define visual and interaction guidelines for building components (including design principles and component behaviors).

6. `_docs/planning/milestones/00-initial-milestones/theme-rules.md`

   - Establish theming foundations (colors, typography, etc) to be incorporated into UI development.

7. `_docs/planning/milestones/00-initial-milestones/project-rules.md`
...
## Below are recommended steps/prompts for creating these files from scratch, with only the project overview (README) to guide you.

1. PROMPT:

```
Use @_docs/planning/milestones/00-initial-milestones/README.md to create a document at `_docs/planning/milestones/00-initial-milestones/user-flow.md`, which should define the user journey through different segments of the application.
...
```
Use @_docs/planning/milestones/00-initial-milestones/README.md and @_docs/planning/milestones/00-initial-milestones/user-flow.md to create a document at `_docs/planning/milestones/00-initial-milestones/auth.md`, which describes how authentication works in the app.
```
...
```
Use @_docs/planning/milestones/00-initial-milestones/README.md, @_docs/planning/milestones/00-initial-milestones/user-flow.md, and @_docs/planning/milestones/00-initial-milestones/auth.md to make recommendations for our stack. I already know I want to use ___, ___, and ___ (e.g. TypeScript, React, Tailwind).
...
4. USER ACTION: Look through the proposed stack and think about what you want to pick. For ones you're unsure of, ask about pros/cons, see what's most compatible with the rest of the stack, etc. When you're done, ask the AI to output the decisions in `_docs/planning/milestones/00-initial-milestones/tech-stack.md`.

5. PROMPT:

```
Update @_docs/planning/milestones/00-initial-milestones/tech-stack.md to cover all best-practices, limitations, and conventions for using the selected technologies. It should be thorough, and include important considerations and common pitfalls for each one.
```
...
Observe @_docs/planning/milestones/00-initial-milestones/README.md and @_docs/planning/milestones/00-initial-milestones/user-flow.md for context about the project to guide your recommendations.
```
...
Use @_docs/planning/milestones/00-initial-milestones/README.md, @_docs/planning/milestones/00-initial-milestones/user-flow.md, and @_docs/planning/milestones/00-initial-milestones/tech-stack.md to put together two new files: `_docs/planning/milestones/00-initial-milestones/ui-rules.md` and `_docs/planning/milestones/00-initial-milestones/theme-rules.md`. The former should focus on common design principles for our application to follow, while the latter should outline all the colors and styles we're using to create a consistent theme across our application.
```
...
Use @_docs/planning/milestones/00-initial-milestones/tech-stack.md, @_docs/planning/milestones/00-initial-milestones/user-flow.md, @_docs/planning/milestones/00-initial-milestones/README.md, @_docs/planning/milestones/00-initial-milestones/auth.md, @_docs/planning/milestones/00-initial-milestones/ui-rules.md, and @_docs/planning/milestones/00-initial-milestones/theme-rules.md to put together a new file at `_docs/planning/milestones/00-initial-milestones/project-rules.md`, which touches on our project's directory structure, file naming conventions, and any other rules we need to follow.
```
