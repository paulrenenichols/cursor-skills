...
**Optional next step:** If I ask you to turn this exploration into a milestone, follow [new-milestone-setup.md](new-milestone-setup.md) to create the milestone structure (_docs/milestones/<NN-milestone>/, phases, phase-plans, and optionally README + topic files under _docs/planning/milestones/<NN-milestone>/).
```
